...
const $ae04d9449fcac817$export$6ed414b8d8bead88 = {
    version: "Preview",
    init: false,
    finished: false,
    _time: {
        ...
        getSessionTime: ()=>{
            let sessionTime;
            if ($ae04d9449fcac817$export$6ed414b8d8bead88._time.startTime) sessionTime = new Date().getTime() - $ae04d9449fcac817$export$6ed414b8d8bead88._time.startTime.getTime();
            return $ae04d9449fcac817$export$6ed414b8d8bead88._time.convert(sessionTime);
        },
        end: undefined,
        convert: (total)=>{
            function ZeroPad(val, pad) {
    ...
    getError: (printError)=>{
        printError = printError === undefined || printError === null ? true : printError;
        const [isInit, API] = $ae04d9449fcac817$export$6ed414b8d8bead88.isInitialized();
        if (!isInit) return {
            error: true,
            message: "Service is not initialized"
        };
    ...
    commit: ()=>{
        ...
        $ae04d9449fcac817$export$6ed414b8d8bead88.setValue("cmi.core.session_time", $ae04d9449fcac817$export$6ed414b8d8bead88._time.getSessionTime());
        API.LMSCommit("");
        return [
            false
        ];
    ...
    exit: ()=>{
        console.debug("API.Exit");
        return $ae04d9449fcac817$export$6ed414b8d8bead88.commit();
    },
    isInitialized: ()=>{
        $ae04d9449fcac817$export$6ed414b8d8bead88.init = false;
        if (!$ae04d9449fcac817$export$6ed414b8d8bead88.API) {
            console.error("MISSING_SCORM_API - INIT");
            return [
                $ae04d9449fcac817$export$6ed414b8d8bead88.init,
                false
            ];
        }
        // @ts-ignore
        if ($ae04d9449fcac817$export$6ed414b8d8bead88.API.Initialized === "false") {
            console.error("API failed to initialize");
            return [
                $ae04d9449fcac817$export$6ed414b8d8bead88.init,
                false
        ...
        $ae04d9449fcac817$export$6ed414b8d8bead88.init = true;
        return [
            $ae04d9449fcac817$export$6ed414b8d8bead88.init,
            $ae04d9449fcac817$export$6ed414b8d8bead88.API
        ];
    },
    updateLocation: (location, slideId)=>{
        console.debug(`API.UpdateLocation`);
        ...
        $ae04d9449fcac817$export$6ed414b8d8bead88.setValue("cmi.core.lesson_location", JSON.stringify({
            v1: 1,
            ...location,
            slideId: slideId
        }));
        $ae04d9449fcac817$export$6ed414b8d8bead88.commit();
        return [
            false
        ];
    },
    getLocation: ()=>{
        ...
        try {
            const [error, location] = $ae04d9449fcac817$export$6ed414b8d8bead88.getValue("cmi.core.lesson_location");
            if (error || !location) return [
                true,
                {}
            ];
    ...
    getProgress: ()=>{
        ...
        try {
            const [error, progress] = $ae04d9449fcac817$export$6ed414b8d8bead88.getValue("cmi.suspend_data");
            if (error || !progress) return [
                true,
                {}
            ];
    ...
    updateProgress: (progressPercentage)=>{
        ...
        const [progressError, previousProgress] = $ae04d9449fcac817$export$6ed414b8d8bead88.getValue("cmi.suspend_data");
        // error 403 = Data Model Element Value Not Initialized (first time setting progress)
        // @ts-ignore
        if (progressError && previousProgress.data.id === "403") {
            $ae04d9449fcac817$export$6ed414b8d8bead88.setValue("cmi.suspend_data", progressPercentage);
            $ae04d9449fcac817$export$6ed414b8d8bead88.commit();
        }
        if (!progressError) {
            if (!previousProgress || parseFloat(previousProgress) === 0 || progressPercentage > parseFloat(previousProgress)) $ae04d9449fcac817$export$6ed414b8d8bead88.setValue("cmi.suspend_data", progressPercentage);
            $ae04d9449fcac817$export$6ed414b8d8bead88.commit();
        }
        return [
            false
    ...
    start: (api)=>{
        ...
        console.log(api);
        $ae04d9449fcac817$export$6ed414b8d8bead88.API = api;
        console.log("service", $ae04d9449fcac817$export$6ed414b8d8bead88);
        // prettier-ignore
        var initialData = {
            "learner_id": "123",
            "learner_name": "Sean Clarke"
        };
        $ae04d9449fcac817$export$6ed414b8d8bead88._time.startTime = new Date();
        console.log("service", $ae04d9449fcac817$export$6ed414b8d8bead88);
        // @ts-ignore
        console.log(window.API_1484_11);
        // service.API = window.API_1484_11;
        // @ts-ignore
        $ae04d9449fcac817$export$6ed414b8d8bead88.API?.loadFromJSON(initialData);
        // @ts-ignore
        $ae04d9449fcac817$export$6ed414b8d8bead88.API?.Initialize();
        // @ts-ignore
        $ae04d9449fcac817$export$6ed414b8d8bead88.API?.lmsSetValue("cmi.completion_status", "incomplete");
        console.log($ae04d9449fcac817$export$6ed414b8d8bead88);
        console.log("api", api);
        $ae04d9449fcac817$export$6ed414b8d8bead88.API?.Commit();
    ...
    finish: ()=>{
        ...
        $ae04d9449fcac817$export$6ed414b8d8bead88.setValue("cmi.core.score.raw", 100);
        $ae04d9449fcac817$export$6ed414b8d8bead88.setValue("cmi.core.lesson_status", "passed");
        $ae04d9449fcac817$export$6ed414b8d8bead88.setValue("cmi.suspend_data", 1);
        $ae04d9449fcac817$export$6ed414b8d8bead88.commit();
        API.LMSFinish("");
        return [
            false
    ...
    setValue: (elem, val)=>{
        ...
        if (val !== undefined) {
            if (API.LMSSetValue(elem, val) === "false") $ae04d9449fcac817$export$6ed414b8d8bead88.getError(true);
        } else console.warn(`Unable to set value for ${elem}: value undefined`);
        return [
            false
        ];
    ...
    getValue: (elem)=>{
        ...
        if (getRes === "") {
            console.error(`API failed to get value for: ${elem}`);
            $ae04d9449fcac817$export$6ed414b8d8bead88.getError(true);
        }
        return [
            false,
            getRes
...
var $ae04d9449fcac817$export$2e2bcd8739ae039 = {
    service: $ae04d9449fcac817$export$6ed414b8d8bead88
};
...
const $b3d1e3300d945f09$export$6ed414b8d8bead88 = {
    ...
    start: (apiPreference)=>{
        ...
        switch(apiPreference){
            case (0, $ae04d9449fcac817$export$6ed414b8d8bead88).version:
                ...
                Object.assign($b3d1e3300d945f09$export$6ed414b8d8bead88, (0, $ae04d9449fcac817$export$6ed414b8d8bead88));
                break;
