...
const $704b14303ded74fd$export$6ed414b8d8bead88 = {
    ...
    start: (api, courseName)=>{
        ...
        $704b14303ded74fd$export$6ed414b8d8bead88.courseName = courseName;
...
const $11bf965a91c52e9c$var$TinCan = window["TinCan"];
const $11bf965a91c52e9c$export$6ed414b8d8bead88 = {
    //@ts-ignore
    version: "xAPI",
    init: false,
    finished: false,
    ...
    _time: {
        ...
        getSessionTime: ()=>{
            let sessionTime;
            if ($11bf965a91c52e9c$export$6ed414b8d8bead88._time.startTime) sessionTime = new Date().getTime() - $11bf965a91c52e9c$export$6ed414b8d8bead88._time.startTime.getTime();
            return $11bf965a91c52e9c$export$6ed414b8d8bead88._time.convert(sessionTime);
        },
        end: undefined,
        convert: (total)=>{
            let totalMs = total % 1000;
    ...
    getError: (printError)=>{
        printError = printError === undefined || printError === null ? true : printError;
        const [isInit, API] = $11bf965a91c52e9c$export$6ed414b8d8bead88.isInitialized();
        if (!isInit) return {
            error: true,
            message: "Service is not initialized"
        };
    ...
    commit: ()=>{
        ...
        $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.session_time", $11bf965a91c52e9c$export$6ed414b8d8bead88._time.getSessionTime());
        API.Commit("");
        return [
            false
        ];
    ...
    exit: ()=>{
        console.debug("API.Exit");
        return $11bf965a91c52e9c$export$6ed414b8d8bead88.commit();
    },
    isInitialized: ()=>{
        $11bf965a91c52e9c$export$6ed414b8d8bead88.init = false;
        if (!$11bf965a91c52e9c$export$6ed414b8d8bead88.API) {
            console.error("MISSING_SCORM_API - INIT");
            return [
                $11bf965a91c52e9c$export$6ed414b8d8bead88.init,
                false
            ];
        }
        // @ts-ignore
        if ($11bf965a91c52e9c$export$6ed414b8d8bead88.API.Initialized === "false") {
            console.error("API failed to initialize");
            return [
                $11bf965a91c52e9c$export$6ed414b8d8bead88.init,
                false
        ...
        $11bf965a91c52e9c$export$6ed414b8d8bead88.init = true;
        return [
            $11bf965a91c52e9c$export$6ed414b8d8bead88.init,
            $11bf965a91c52e9c$export$6ed414b8d8bead88.API
        ];
    },
    updateLocation: (location, slideId)=>{
        ...
        $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.location", JSON.stringify({
            v1: 1,
            ...location,
            slideId: slideId
        }));
        $11bf965a91c52e9c$export$6ed414b8d8bead88.commit();
        console.debug(`API.UpdateLocationXAPI`);
        var advanceSlideExperience = new $11bf965a91c52e9c$var$TinCan.Statement({
            actor: {
                name: $11bf965a91c52e9c$export$6ed414b8d8bead88.API ? $11bf965a91c52e9c$export$6ed414b8d8bead88.API.LearnerName : "",
                mbox: `mailto:${$11bf965a91c52e9c$export$6ed414b8d8bead88.API ? $11bf965a91c52e9c$export$6ed414b8d8bead88.API.LearnerId : ""}`
            },
            verb: {
                id: "http://adlnet.gov/expapi/verbs/experienced"
            },
            target: {
                id: `https://osg.ca/api/v1/activities/courses/${$11bf965a91c52e9c$export$6ed414b8d8bead88.courseName}/update-slide-${slideId}`,
                definition: {
                    name: {
        ...
        // @ts-ignore
        $11bf965a91c52e9c$export$6ed414b8d8bead88.tincan.saveStatement(advanceSlideExperience, {
    ...
    getLocation: ()=>{
        ...
        try {
            const [error, location] = $11bf965a91c52e9c$export$6ed414b8d8bead88.getValue("cmi.location");
            if (error || !location) return [
                true,
                {}
            ];
    ...
    getProgress: ()=>{
        ...
        try {
            const [error, progress] = $11bf965a91c52e9c$export$6ed414b8d8bead88.getValue("cmi.progress_measure");
            if (error || !progress) return [
                true,
                {}
            ];
    ...
    updateProgress: (project, progressPercentage, lessonId, moduleCompleted, completedModule)=>{
        ...
        const [progressError, previousProgress] = $11bf965a91c52e9c$export$6ed414b8d8bead88.getValue("cmi.progress_measure");
        // error 403 = Data Model Element Value Not Initialized (first time setting progress)
        // @ts-ignore
        if (progressError && previousProgress.data.id === "403") {
            $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.progress_measure", progressPercentage);
            $11bf965a91c52e9c$export$6ed414b8d8bead88.commit();
        }
        if (!progressError) {
            if (!previousProgress || parseFloat(previousProgress) === 0 || progressPercentage > parseFloat(previousProgress)) $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.progress_measure", progressPercentage);
            $11bf965a91c52e9c$export$6ed414b8d8bead88.commit();
        }
        let statements = [];
        let completedModuleExperience;
        var completedLessonExperience = new $11bf965a91c52e9c$var$TinCan.Statement({
            actor: {
                name: $11bf965a91c52e9c$export$6ed414b8d8bead88.API ? $11bf965a91c52e9c$export$6ed414b8d8bead88.API.LearnerName : "",
                mbox: `mailto:${$11bf965a91c52e9c$export$6ed414b8d8bead88.API ? $11bf965a91c52e9c$export$6ed414b8d8bead88.API.LearnerId : ""}`
            },
        ...
        if (moduleCompleted) {
            completedModuleExperience = new $11bf965a91c52e9c$var$TinCan.Statement({
                actor: {
                    name: $11bf965a91c52e9c$export$6ed414b8d8bead88.API ? $11bf965a91c52e9c$export$6ed414b8d8bead88.API.LearnerName : "",
                    mbox: `mailto:${$11bf965a91c52e9c$export$6ed414b8d8bead88.API ? $11bf965a91c52e9c$export$6ed414b8d8bead88.API.LearnerId : ""}`
                },
        ...
        statements.forEach((statement)=>{
            // @ts-ignore
            $11bf965a91c52e9c$export$6ed414b8d8bead88.tincan.saveStatement(statement, {
                callback: function(err, xhr) {
                    if (err !== null) {
                        if (xhr !== null) {
                            console.log("Failed to save statement: " + xhr.responseText + " (" + xhr.status + ")");
    ...
    start: (api, courseName)=>{
        ...
        $11bf965a91c52e9c$export$6ed414b8d8bead88.API = api;
        $11bf965a91c52e9c$export$6ed414b8d8bead88.courseName = courseName;
        $11bf965a91c52e9c$export$6ed414b8d8bead88._time.startTime = new Date();
        $11bf965a91c52e9c$export$6ed414b8d8bead88.API?.Initialize("");
        const [isInit, API] = $11bf965a91c52e9c$export$6ed414b8d8bead88.isInitialized();
        if (!isInit || !API) return [
            true
        ];
        const [statusError, completionStatus] = $11bf965a91c52e9c$export$6ed414b8d8bead88.getValue("cmi.completion_status");
        if (statusError) return [
            true
        ];
        if (completionStatus === "unknown") {
            $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.completion_status", "incomplete");
            $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.success_status", "unknown");
            $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.suspend_data", "{}");
            const startLocation = {
                cur: {
                    m: 0,
                    l: 0,
            ...
            $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.location", JSON.stringify(startLocation));
        } else {
            // service.setValue(
            //   'cmi.score.scaled',
            //   service.getValue('cmi.score.scaled')[1]
            // );
            // service.setValue('cmi.score.raw', service.getValue('cmi.score.raw')[1]);
            $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.success_status", $11bf965a91c52e9c$export$6ed414b8d8bead88.getValue("cmi.success_status")[1]);
            $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.progress_measure", $11bf965a91c52e9c$export$6ed414b8d8bead88.getValue("cmi.progress_measure")[1]);
            $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.completion_status", $11bf965a91c52e9c$export$6ed414b8d8bead88.getValue("cmi.completion_status")[1]);
        }
        // until we have things hooked up to exit buttons/nav, set exit to 'suspend' as part of start() so that status persists whether the user finishes or exits
        $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.exit", "suspend");
        $11bf965a91c52e9c$export$6ed414b8d8bead88.commit();
        console.debug("runtime started");
        if ($11bf965a91c52e9c$var$TinCan) {
            try {
                // @ts-ignore
                $11bf965a91c52e9c$export$6ed414b8d8bead88.tincan = new $11bf965a91c52e9c$var$TinCan.LRS({
            ...
            const statements = [];
            var intializeCourse = new $11bf965a91c52e9c$var$TinCan.Statement({
                actor: {
                    name: $11bf965a91c52e9c$export$6ed414b8d8bead88.API ? $11bf965a91c52e9c$export$6ed414b8d8bead88.API.LearnerName : "",
                    mbox: `mailto:${$11bf965a91c52e9c$export$6ed414b8d8bead88.API ? $11bf965a91c52e9c$export$6ed414b8d8bead88.API.LearnerId : ""}`
                },
    ...
    finish: (moduleIndex)=>{
        ...
        $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.score.min", 0);
        $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.score.max", 100);
        $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.score.scaled", 1);
        $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.score.raw", 100);
        $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.success_status", "passed");
        $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.progress_measure", 1);
        $11bf965a91c52e9c$export$6ed414b8d8bead88.setValue("cmi.completion_status", "completed");
        $11bf965a91c52e9c$export$6ed414b8d8bead88.commit();
        API.Terminate("");
        let statements = [];
        const completedModuleExperience = new $11bf965a91c52e9c$var$TinCan.Statement({
            actor: {
                name: $11bf965a91c52e9c$export$6ed414b8d8bead88.API ? $11bf965a91c52e9c$export$6ed414b8d8bead88.API.LearnerName : "",
                mbox: `mailto:${$11bf965a91c52e9c$export$6ed414b8d8bead88.API ? $11bf965a91c52e9c$export$6ed414b8d8bead88.API.LearnerId : ""}`
            },
            ...
            target: {
                id: `https://osg.ca/api/v1/activities/courses/${$11bf965a91c52e9c$export$6ed414b8d8bead88.courseName}/completed-module-${moduleIndex}`,
                definition: {
                    name: {
        ...
        const completedCourseStatement = new $11bf965a91c52e9c$var$TinCan.Statement({
            actor: {
                name: $11bf965a91c52e9c$export$6ed414b8d8bead88.API ? $11bf965a91c52e9c$export$6ed414b8d8bead88.API.LearnerName : "",
                mbox: `mailto:${$11bf965a91c52e9c$export$6ed414b8d8bead88.API ? $11bf965a91c52e9c$export$6ed414b8d8bead88.API.LearnerId : ""}`
            },
            ...
            target: {
                id: `https://osg.ca/api/v1/activities/courses/${$11bf965a91c52e9c$export$6ed414b8d8bead88.courseName}`,
                definition: {
                    name: {
                        "en-US": $11bf965a91c52e9c$export$6ed414b8d8bead88.courseName
                    }
                }
            },
            result: {
    ...
    setValue: (elem, val)=>{
        ...
        if (val !== undefined) {
            if (API.SetValue(elem, val) === "false") $11bf965a91c52e9c$export$6ed414b8d8bead88.getError(true);
        } else console.warn(`Unable to set value for ${elem}: value undefined`);
        return [
            false
        ];
    ...
    getValue: (elem)=>{
        ...
        if (getRes === "") {
            console.error(`API failed to get value for: ${elem}`);
            $11bf965a91c52e9c$export$6ed414b8d8bead88.getError(true);
        }
        return [
            false,
            getRes
...
var $11bf965a91c52e9c$export$2e2bcd8739ae039 = {
    service: $11bf965a91c52e9c$export$6ed414b8d8bead88
};
    ...
    start: (apiPreference, courseName)=>{
        ...
        switch(apiPreference){
            case (0, $704b14303ded74fd$export$6ed414b8d8bead88).version:
                ...
                break;
            case (0, $11bf965a91c52e9c$export$6ed414b8d8bead88).version:
                API = $defce2f29876acb7$export$6ed414b8d8bead88._scanApi(window, "API_1484_11");
                $defce2f29876acb7$export$6ed414b8d8bead88.version = apiPreference;
                Object.assign($defce2f29876acb7$export$6ed414b8d8bead88, (0, $11bf965a91c52e9c$export$6ed414b8d8bead88));
                break;
        ...
        $defce2f29876acb7$export$6ed414b8d8bead88.start(API, courseName);
        return [
            true
        ];
    }
